...
* Install Package with Salesforce UI ([Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tf4000003vWO1)) ([Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tf4000003vWO1))
* Install Package with Salesforce CLI (`sfdx force:package:install --package 04tf4000003vWO1 --wait 10`)
